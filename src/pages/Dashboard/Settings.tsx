    ...
    const fetchSettings = async () => {
      try {
        ...
        if (settings) {
          ...
          if (settings.payment?.methods) setPaymentMethods(settings.payment.methods);
        }
      } catch (error) {
                    ...
                    <div key={method.id} className="payment-method">
                      <div className="method-info">
                        ...
                        <span className="method-desc">
                          {method.id === 'cash' && 'يدفع العميل عند استلام الطلب'}
            ...
            <div className="settings-card">
              ...
              <div className="settings-form">
                <div className="security-info">
                  ...
                  <p><strong>الدور:</strong> {user?.role === 'admin' ? 'مدير النظام' : 'عميل'}</p>
                  <p><strong>آخر تسجيل دخول:</strong> الآن</p>
                </div>
                <div className="form-group">
                  <button className="btn btn-outline">تغيير كلمة المرور</button>
                </div>
                <div className="form-group">
                  <button className="btn btn-outline">تفعيل المصادقة الثنائية</button>
                </div>
              </div>
            </div>
          )}
